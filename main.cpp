...
Input Parameter: 1st value-the directory string value,
                 2nd value-the location of the vector of where the file paths are going to be
                 3rd value-the location of the vector of where the names paths are going to be
Output Parameter: return 0 value
Definition: Going to go to the directory and put the files in the file vector
 *******************************************************************************************/
int getdir (string dir, vector<string> &files, vector<string> &names);
...
int main(int argc, char *argv[])
{
    ...
    int minCheatsize = atoi(argv[3]);


    getdir(dir, files, names);
    ...
    for(int Size = files.size(); Size!=0; Size--)
    {
        ...
        while(tempstring != "flag")
        {       //if tempstring="flag", then the file has finished being read
    ...
    table.getCheaters(files.size(), names, minCheatsize);
